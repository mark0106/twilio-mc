// Static map of Twilio messaging error codes → human-readable descriptions.
// Covers the codes most commonly seen on SMS campaigns; for anything not in
// the map we still show the raw code so the user can look it up.
